...
public class State {
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        result = result * PRIME + Arrays.hashCode(this.getBoard());
        result = result * PRIME + this.getTreasuryRed();
        result = result * PRIME + this.getTreasuryBlue();
        result = result * PRIME + (this.isRedTurn() ? 79 : 97);
        return result;
    }
