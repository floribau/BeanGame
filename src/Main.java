...
public class Main {
    ...
    private static String getGameId() throws Exception {
    ...
    static void play(String gameID, boolean redPlayer) throws Exception {
        ...
        while (true) {
            ...
            if (stateID != 2 && ((startOpponent <= moveState && moveState <= endOpponent) || moveState == -1)) {
                ...
                System.out.println("Alpha-Beta-Search beendet.");
    ...
    static String getResponse(String url) throws URISyntaxException, IOException {
